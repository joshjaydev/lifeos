...
public final class TimeBlockDao_Impl implements TimeBlockDao {
  ...
  @Override
  public Flow<List<TimeBlockEntity>> getAllTimeBlocks(final String userId) {
    final String _sql = "SELECT * FROM time_blocks WHERE user_id = ? ORDER BY block_date ASC, start_time ASC";
