...
public final class GoalDao_Impl implements GoalDao {
  ...
  public GoalDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfGoalEntity = new EntityInsertionAdapter<GoalEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `goals` (`id`,`user_id`,`what_do_you_want`,`folder_id`,`notebook_id`,`created_at`,`updated_at`) VALUES (?,?,?,?,?,?,?)";
      }
      ...
      protected void bind(@NonNull final SupportSQLiteStatement statement,
        ...
        statement.bindString(3, entity.getWhatDoYouWant());
        if (entity.getFolderId() == null) {
          statement.bindNull(4);
        } else {
          statement.bindString(4, entity.getFolderId());
        }
        if (entity.getNotebookId() == null) {
          statement.bindNull(5);
        } else {
          statement.bindString(5, entity.getNotebookId());
        }
    ...
    this.__updateAdapterOfGoalEntity = new EntityDeletionOrUpdateAdapter<GoalEntity>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `goals` SET `id` = ?,`user_id` = ?,`what_do_you_want` = ?,`folder_id` = ?,`notebook_id` = ?,`created_at` = ?,`updated_at` = ? WHERE `id` = ?";
      }
    ...
    this.__preparedStmtOfDeleteAll = new SharedSQLiteStatement(__db) {
      ...
      @NonNull
      public String createQuery() {
        final String _query = "DELETE FROM goals WHERE user_id = ?";
        return _query;
      }
    };
  }
  ...
  @Override
  public Flow<List<GoalEntity>> getGoals(final String userId) {
    final String _sql = "SELECT * FROM goals WHERE user_id = ? ORDER BY created_at DESC";
    ...
    return CoroutinesRoom.createFlow(__db, false, new String[] {"goals"}, new Callable<List<GoalEntity>>() {
      ...
      public List<GoalEntity> call() throws Exception {
        ...
        try {
          ...
          final int _cursorIndexOfWhatDoYouWant = CursorUtil.getColumnIndexOrThrow(_cursor, "what_do_you_want");
          ...
          while (_cursor.moveToNext()) {
            ...
            final String _tmpWhatDoYouWant;
            _tmpWhatDoYouWant = _cursor.getString(_cursorIndexOfWhatDoYouWant);
            ...
            if (_cursor.isNull(_cursorIndexOfNotebookId)) {
              _tmpNotebookId = null;
            } else {
            ...
            _item = new GoalEntity(_tmpId,_tmpUserId,_tmpWhatDoYouWant,_tmpFolderId,_tmpNotebookId,_tmpCreatedAt,_tmpUpdatedAt);
            _result.add(_item);
          }
          return _result;
        } finally {
  ...
  @Override
  public Flow<GoalEntity> getGoal(final String id) {
      ...
      public GoalEntity call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            _result = new GoalEntity(_tmpId,_tmpUserId,_tmpWhatDoYouWant,_tmpFolderId,_tmpNotebookId,_tmpCreatedAt,_tmpUpdatedAt);
          } else {
            _result = null;
          }
          return _result;
