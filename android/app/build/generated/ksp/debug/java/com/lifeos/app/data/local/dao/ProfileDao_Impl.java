...
public final class ProfileDao_Impl implements ProfileDao {
  ...
  public ProfileDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfProfileEntity = new EntityInsertionAdapter<ProfileEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `profiles` (`id`,`email`,`display_name`,`avatar_url`,`time_block_size`,`created_at`,`updated_at`) VALUES (?,?,?,?,?,?,?)";
      }
      ...
      protected void bind(@NonNull final SupportSQLiteStatement statement,
        ...
        statement.bindLong(5, entity.getTimeBlockSize());
    ...
    this.__updateAdapterOfProfileEntity = new EntityDeletionOrUpdateAdapter<ProfileEntity>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `profiles` SET `id` = ?,`email` = ?,`display_name` = ?,`avatar_url` = ?,`time_block_size` = ?,`created_at` = ?,`updated_at` = ? WHERE `id` = ?";
      }
  ...
  @Override
  public Object update(final ProfileEntity profile, final Continuation<? super Unit> $completion) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      @NonNull
      public Unit call() throws Exception {
    ...
    return CoroutinesRoom.createFlow(__db, false, new String[] {"profiles"}, new Callable<ProfileEntity>() {
      ...
      public ProfileEntity call() throws Exception {
        ...
        try {
          ...
          final int _cursorIndexOfTimeBlockSize = CursorUtil.getColumnIndexOrThrow(_cursor, "time_block_size");
          ...
          if (_cursor.moveToFirst()) {
            ...
            final int _tmpTimeBlockSize;
            _tmpTimeBlockSize = _cursor.getInt(_cursorIndexOfTimeBlockSize);
            ...
            _result = new ProfileEntity(_tmpId,_tmpEmail,_tmpDisplayName,_tmpAvatarUrl,_tmpTimeBlockSize,_tmpCreatedAt,_tmpUpdatedAt);
          } else {
            _result = null;
          }
          return _result;
