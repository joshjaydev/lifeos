...
public final class AppModule_ProvideTimeBlockDaoFactory implements Factory<TimeBlockDao> {
  ...
  public AppModule_ProvideTimeBlockDaoFactory(Provider<LifeOSDatabase> databaseProvider) {
  ...
  public static AppModule_ProvideTimeBlockDaoFactory create(
      Provider<LifeOSDatabase> databaseProvider) {
    return new AppModule_ProvideTimeBlockDaoFactory(databaseProvider);
  }

  public static TimeBlockDao provideTimeBlockDao(LifeOSDatabase database) {
    return Preconditions.checkNotNullFromProvides(AppModule.INSTANCE.provideTimeBlockDao(database));
  }
}
