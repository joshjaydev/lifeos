...
import com.lifeos.app.di.AppModule_ProvideNotebookRepositoryFactory;
...
import com.lifeos.app.ui.screens.notes.NotesViewModel;
import com.lifeos.app.ui.screens.notes.NotesViewModel_HiltModules_KeyModule_ProvideFactory;
...
public final class DaggerLifeOSApplication_HiltComponents_SingletonC {
  ...
  private static final class ActivityCImpl extends LifeOSApplication_HiltComponents.ActivityC {
    ...
    public Set<String> getViewModelKeys() {
      return SetBuilder.<String>newSetBuilder(5).add(ActionsViewModel_HiltModules_KeyModule_ProvideFactory.provide()).add(AtmanViewModel_HiltModules_KeyModule_ProvideFactory.provide()).add(NotesViewModel_HiltModules_KeyModule_ProvideFactory.provide()).add(TimeViewModel_HiltModules_KeyModule_ProvideFactory.provide()).add(ValuesViewModel_HiltModules_KeyModule_ProvideFactory.provide()).build();
    }
  ...
  private static final class ViewModelCImpl extends LifeOSApplication_HiltComponents.ViewModelC {
    ...
    private void initialize(final SavedStateHandle savedStateHandleParam,
      ...
      this.timeViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 3);
      this.valuesViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 4);
    }

    @Override
    public Map<String, Provider<ViewModel>> getHiltViewModelMap() {
      return MapBuilder.<String, Provider<ViewModel>>newMapBuilder(5).put("com.lifeos.app.ui.screens.actions.ActionsViewModel", ((Provider) actionsViewModelProvider)).put("com.lifeos.app.ui.screens.atman.AtmanViewModel", ((Provider) atmanViewModelProvider)).put("com.lifeos.app.ui.screens.notes.NotesViewModel", ((Provider) notesViewModelProvider)).put("com.lifeos.app.ui.screens.time.TimeViewModel", ((Provider) timeViewModelProvider)).put("com.lifeos.app.ui.screens.values.ValuesViewModel", ((Provider) valuesViewModelProvider)).build();
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          case 2: // com.lifeos.app.ui.screens.notes.NotesViewModel 
          return (T) new NotesViewModel(singletonCImpl.provideNoteRepositoryProvider.get(), singletonCImpl.provideNotebookRepositoryProvider.get());

          case 3: // com.lifeos.app.ui.screens.time.TimeViewModel 
          return (T) new TimeViewModel(ApplicationContextModule_ProvideContextFactory.provideContext(singletonCImpl.applicationContextModule), singletonCImpl.getActionsUseCase(), singletonCImpl.getFoldersUseCase(), singletonCImpl.completeActionUseCase(), singletonCImpl.provideTimeBlockRepositoryProvider.get(), singletonCImpl.provideEventRepositoryProvider.get());

          case 4: // com.lifeos.app.ui.screens.values.ValuesViewModel 
  ...
  private static final class SingletonCImpl extends LifeOSApplication_HiltComponents.SingletonC {
    ...
    private void initialize(final ApplicationContextModule applicationContextModuleParam) {
      ...
      this.provideNotebookRepositoryProvider = DoubleCheck.provider(new SwitchingProvider<NotebookRepository>(singletonCImpl, 11));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          case 11: // com.lifeos.domain.repository.NotebookRepository 
          return (T) AppModule_ProvideNotebookRepositoryFactory.provideNotebookRepository(singletonCImpl.provideLocalDatabaseProvider.get());
